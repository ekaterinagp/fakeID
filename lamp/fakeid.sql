...
id`,
`district
`, `street_building_name`, `post_code`, `street_name`) VALUES
...
(10) DEFAULT NULL,
  `new_spouse_id` int
(11) DEFAULT NULL,
  `new_marital_status_id` int
(11) DEFAULT NULL,
  `new_gender_value` varchar
(4) DEFAULT NULL,
...
(10) DEFAULT NULL,
  `old_spouse_id` int
(11) DEFAULT NULL,
  `old_marital_status_id` int
(11) DEFAULT NULL,
  `old_gender_value` varchar
(4) DEFAULT NULL,
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_insert_user` BEFORE
INSERT ON `user` FOR
EACH
ROW
BEGIN
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_update_user` BEFORE
UPDATE ON `user
` FOR EACH ROW
BEGIN
  INSERT INTO audit_user
...
ADD PRIMARY KEY
(`user_id`,`family_relation_id`),
ADD KEY `family_relation_id`
(`family_relation_id`);
...
(`id`),
ADD CONSTRAINT `CONSTRAINT_1` CHECK
(`gender_value` in
('0001','0002'));
...
--
ALTER TABLE `user_family_relation`
ADD CONSTRAINT `user_family_relation_ibfk_1` FOREIGN KEY
(`family_relation_id`) REFERENCES `family_relation`
(`id`),
ADD CONSTRAINT `user_family_relation_ibfk_2` FOREIGN KEY
